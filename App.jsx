    ...
    >
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-mono font-extrabold text-white">Hello Everyone!! This is a small project of Background Changer using React & Tailwind Css.</h1>
          <h2 className="text-3xl mt-2 font-mono font-extrabold text-white">" Click to change the color "</h2>
        </div>
      </div>
      ...
      <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-2xl">
          ...
          <button
          onClick={() => setColor("yellow")}  className="outline-none px-4 py-1 rounded-full text-black shadow-lg" style={{backgroundColor: "yellow"}}>Yellow</button>
          <button
